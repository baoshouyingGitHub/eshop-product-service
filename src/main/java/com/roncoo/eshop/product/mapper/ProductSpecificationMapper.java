...
public interface ProductSpecificationMapper {
	...
	@Select("SELECT id,name,value,product_id productId FROM product_specification WHERE id=#{id}")  
	public ProductSpecification findById(Long id);
	
	@Select("SELECT id,name,value,product_id productId FROM product_specification WHERE product_id=#{productId}")  
